# Generated by Django 2.2.11 on 2021-06-29 03:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='coa.LivestockByproduct', verbose_name='上層物件')),
            ],
            options={
                'verbose_name': '畜禽副產品產量',
                'verbose_name_plural': '畜禽副產品產量',
            },
        ),
    ]
