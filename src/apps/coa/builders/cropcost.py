...
class CropCostBuilder(object):
    """
    建立 農耕生產成本api介面 CropCostApiView 使用的選項

from apps.coa.builders.cropcost import *
builder = CropCostBuilder()
builder.build()
    """
    def __init__(self):
        self.driver = None
    ...
    def build_category(self, text_group):
        ...
        options = group_category.find_elements(By.TAG_NAME, 'option')
        parent = None
    ...
    def build_product(self, text_group):
        ...
        while index < len(options):
            ...
            start_year_options = start_year.find_elements(By.TAG_NAME, 'option')
            ...
            end_year_options = end_year.find_elements(By.TAG_NAME, 'option')
